...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardsMonstersAlien = __webpack_require__(194);
	
	var _cardsMonstersAlien2 = _interopRequireDefault(_cardsMonstersAlien);
	
	var _cardsMonstersAngel = __webpack_require__(195);
	
	var _cardsMonstersAngel2 = _interopRequireDefault(_cardsMonstersAngel);
	
	var _cardsMonstersBeast = __webpack_require__(196);
	
	var _cardsMonstersBeast2 = _interopRequireDefault(_cardsMonstersBeast);
	
	var _cardsMonstersDemon = __webpack_require__(197);
	
	var _cardsMonstersDemon2 = _interopRequireDefault(_cardsMonstersDemon);
	
	var _cardsMonstersDragon = __webpack_require__(198);
	
	var _cardsMonstersDragon2 = _interopRequireDefault(_cardsMonstersDragon);
	
	var _cardsMonstersFusion = __webpack_require__(199);
	
	var _cardsMonstersFusion2 = _interopRequireDefault(_cardsMonstersFusion);
	
	var _cardsMonstersHuman = __webpack_require__(200);
	
	var _cardsMonstersHuman2 = _interopRequireDefault(_cardsMonstersHuman);
	
	var _cardsMonstersMech = __webpack_require__(201);
	
	var _cardsMonstersMech2 = _interopRequireDefault(_cardsMonstersMech);
	
	var _cardsSpellsSpells = __webpack_require__(202);
	
	var _cardsSpellsSpells2 = _interopRequireDefault(_cardsSpellsSpells);
	
	var _cardsTrapsTraps = __webpack_require__(203);
	
	var _cardsTrapsTraps2 = _interopRequireDefault(_cardsTrapsTraps);
	
	$('.container').append($('<code>').text(JSON.stringify(_cardsMonstersAlien2['default'], null, 2)));
...
/***/ function(module, exports) {
	...
	exports["default"] = [{
	    "name": "Archangel of Death",
	    "type": "Angel",
	    "material": ["Angel of Death", "Angelitican"],
	    "attack": 45,
	    "life": 50,
	    "effect": "Once per turn, destroy one monster on your opponent's side of the field and gain life equal to its damage. If this card would be destroyed, an Angel card can be destroyed in its place.",
	    "limited": true
	}, {
	    "name": "Dragon Protector",
	    "type": "Dragon",
	    "material": ["Dragon", "Dragon"],
	    "attack": 40,
	    "life": 24,
	    "effect": "As long as this card is on your side of the field, you cannot take life damage.",
	    "limited": true
	}, {
	    "name": "Gryph Champion",
	    "type": "Human",
	    "material": ["Gryph Soldier", "Gryph Mech"],
	    "attack": 20,
	    "life": 35,
	    "effect": "Your opponent’s monster’s can only attack this card while it is on the field.",
	    "limited": false
	}, {
	    "name": "StevoDuhVillian",
	    "type": "Human",
	    "material": "Gulpin",
	    "attack": 120,
	    "life": 120,
	    "effect": "Unaffected by spells or traps.",
	    "limited": true
	}, {
	    "name": "Void Armored Flyer",
	    "type": "Demon",
	    "material": ["Void Master Knight", "Void Flyer"],
	    "attack": 12,
	    "life": 30,
	    "effect": "",
	    "limited": false
	    ...
	    "attack": 50,
	    "life": 50,
	    "effect": "While this card is on the field, Your opponent’s life decreases by 10% per turn",
	    "limited": true
	}, {
	    "name": "WW Warlock",
	    "type": "Human",
	    ...
	    "material": 23,
	    "life": 43,
	    "effect": "Any spell/trap you played, gained a Chidori to your hand.",
	    "limited": true
	}];
	module.exports = exports["default"];
